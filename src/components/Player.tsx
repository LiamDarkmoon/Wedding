    ...
    return(
        <>
            ...
            <div className="absolute grid h-screen w-screen place-items-center">
                ...
                id="seal"
                onClick={HandleOpen} 
                className={isOpen ? "transition-all duration-1000 opacity-0 hidden": "transition-all fixed bottom-[40%] md:bottom-[20%] z-1002 bg-rose-900 rounded-full w-[140px] h-[140px] drop-shadow-2xl shadow-rose-950 paris text-rose-50 text-3xl cursor-pointer heartbeat"}
                >
                    N&V
                </button>
                <div 
